...
namespace WebOfPlanets
{
    ...
    // Premješteno iz SaveSystem.Dto.cs (konsolidacija malih datoteka, 31. 7. 2026.).
    ...
    // Premješteno iz SaveSystem.Capture.cs (konsolidacija malih datoteka, 31. 7. 2026.).
    ...
    public static partial class SaveSystem
    {
        ...
        private static void GatherMachines(SaveData data, out List<Component> comps)
        {
            ...
            {
                // Stroj usred animacije raspadanja (podignut u hotbar) je za
                // gameplay već mrtav — capture bi ga duplicirao uz item u hotbaru.
                if (DisintegrationEffect.IsPlayingOn(c.gameObject)) return;
        ...
        private static void GatherResources(SaveData data)
        {
            ...
            foreach (var ii in UnityEngine.Object.FindObjectsByType<ItemInteractable>(FindObjectsSortMode.None))
            {
                ...
                // Izrudareni resurs usred animacije raspadanja — capture bi ga oživio.
                if (DisintegrationEffect.IsPlayingOn(ii.gameObject)) continue;
    ...
    // Premješteno iz SaveSystem.Restore.cs (konsolidacija malih datoteka, 31. 7. 2026.).
